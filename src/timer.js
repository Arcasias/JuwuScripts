 ...
 * Cross-reload timer
 *
 * @description This script should be appended where the timer should start, then the timer can be stopped with `timerStop()` and the results of can be printed with `timerLog()`
 * @run false
 */
